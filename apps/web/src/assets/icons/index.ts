...
export { default as LayoutSplitIcon } from "./layout-split";
...
export { default as OpenLedgerIcon } from "./open-ledger";
export { default as FileMinusIcon } from "./file-minus";
export { default as FilePlusIcon } from "./file-plus";
