export const enum ERROR_MESSAGES {
  ...
  // Quotation errors
  QUOTATION_NOT_FOUND = "Quotation not found! Please try again later.",
  QUOTATION_BLOB_NOT_INITIALIZED = "Blob not initialized. Initialize the QuotationDownloadManager",
  QUOTATION_DATA_NOT_INITIALIZED = "Quotation data not initialized. Initialize the QuotationDownloadManager",
  QUOTATION_NAME_NOT_INITIALIZED = "Quotation name not initialized. Initialize the QuotationDownloadManager",
  // Credit Note errors
  CREDIT_NOTE_NOT_FOUND = "Credit Note not found! Please try again later.",
  CREDIT_NOTE_BLOB_NOT_INITIALIZED = "Blob not initialized. Initialize the CreditNoteDownloadManager",
  CREDIT_NOTE_DATA_NOT_INITIALIZED = "Credit Note data not initialized. Initialize the CreditNoteDownloadManager",
  CREDIT_NOTE_NAME_NOT_INITIALIZED = "Credit Note name not initialized. Initialize the CreditNoteDownloadManager",
  // Debit Note errors
  DEBIT_NOTE_NOT_FOUND = "Debit Note not found! Please try again later.",
  DEBIT_NOTE_BLOB_NOT_INITIALIZED = "Blob not initialized. Initialize the DebitNoteDownloadManager",
  DEBIT_NOTE_DATA_NOT_INITIALIZED = "Debit Note data not initialized. Initialize the DebitNoteDownloadManager",
  DEBIT_NOTE_NAME_NOT_INITIALIZED = "Debit Note name not initialized. Initialize the DebitNoteDownloadManager",
}
