...
interface CreditNoteFieldKeyNumberValuesSectionProps {
  reactform: UseFormReturn<ZodCreateCreditNoteSchema>;
...
const CreditNoteFieldKeyNumberValuesSection: React.FC<CreditNoteFieldKeyNumberValuesSectionProps> = ({
  reactform,
  name,
  className,
  label,
...
export default CreditNoteFieldKeyNumberValuesSection;
