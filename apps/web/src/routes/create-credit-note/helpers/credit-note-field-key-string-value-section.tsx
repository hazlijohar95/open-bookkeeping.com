...
interface CreditNoteFieldKeyStringValuesSectionProps {
...
const CreditNoteFieldKeyStringValuesSection: React.FC<CreditNoteFieldKeyStringValuesSectionProps> = ({
  reactform,
  name,
  className,
  label,
...
export default CreditNoteFieldKeyStringValuesSection;
