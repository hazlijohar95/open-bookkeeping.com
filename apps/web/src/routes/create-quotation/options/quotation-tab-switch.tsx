...
interface QuotationTabSwitchProps {
  onTabChange?: (tab: QuotationTab) => void;
}

const QuotationTabSwitch = ({ onTabChange }: QuotationTabSwitchProps) => {
  const quotationTab = useAtomValue(quotationTabAtom);

  const handleValueChange = (value: string) => {
    onTabChange?.(value as QuotationTab);
  };

  return (
    <Tabs value={quotationTab} onValueChange={handleValueChange}>
...
export default QuotationTabSwitch;
