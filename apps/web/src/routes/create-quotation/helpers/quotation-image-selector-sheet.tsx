...
interface QuotationImageSelectorSheetProps {
...
export const QuotationImageSelectorSheet = ({
  children,
  type,
  isLoading = false,
  idbImages,
  ...
  onUrlChange,
  onBase64Change,
}: QuotationImageSelectorSheetProps) => {
      ...
      <SheetContent className="scroll-bar-hidden w-[90%] !max-w-lg overflow-y-scroll">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col gap-4 p-4">
            ...
            {/* Local Images Section - Only show if not server quotation */}
            {params?.type !== "server" && (
              <div className="flex flex-col gap-4">
                <div>
                ...
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Don&apos;t select local {type} if you are using server quotation storage. {type} will not be saved in your quotation.
                  </AlertDescription>
                </Alert>
