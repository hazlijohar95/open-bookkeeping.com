...
interface QuotationFieldKeyNumberValuesSectionProps {
...
const QuotationFieldKeyNumberValuesSection: React.FC<QuotationFieldKeyNumberValuesSectionProps> = ({
  reactform,
  name,
  className,
  label,
...
export default QuotationFieldKeyNumberValuesSection;
