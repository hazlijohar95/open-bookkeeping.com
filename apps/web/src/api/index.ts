...
export {
  ...
  useFixedAssetCategory,
  useCreateFixedAssetCategory,
  useUpdateFixedAssetCategory,
  useDeleteFixedAssetCategory,
  fixedAssetKeys,
} from "./fixed-assets";
export type {
  FixedAsset,
  ...
  DisposeAssetInput,
  CreateCategoryInput as CreateFixedAssetCategoryInput,
  UpdateCategoryInput as UpdateFixedAssetCategoryInput,
